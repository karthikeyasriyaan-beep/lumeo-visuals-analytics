  ...
  return (
    <section className="mt-12 pt-8 border-t border-border">
      <div className="flex items-start gap-4 p-6 rounded-2xl bg-muted/30 border border-border/50">
        ...
        <div>
          <h3 className="text-lg font-bold mb-1">About the Trame Team</h3>
          <p className="text-sm text-muted-foreground mb-3">
            The Trame editorial team consists of personal finance experts, certified financial planners, and experienced writers dedicated to helping you take control of your money. Our mission is to provide actionable, research-backed financial guidance that makes sense for real life.
          </p>
