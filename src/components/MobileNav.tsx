...
const navigation = [
  ...
  { name: "Receipts", href: "/receipts", icon: Calculator },
            ...
            >
              <div className="p-4 sm:p-6 space-y-2">
                  ...
                  return (
                    ...
                    >
                      <Link
                        to={item.href}
                        onClick={() => setIsOpen(false)}
                        className={`flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg transition-all min-h-[44px] ${
                          isActive
                ...
                >
                  <Button
                    variant="ghost"
                    className="w-full justify-start gap-3 min-h-[44px] text-sm sm:text-base"
